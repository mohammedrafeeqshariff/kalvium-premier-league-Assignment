...
function sortByAge(players) {
  // Use the Array.sort() method to sort the players by age in descending order
  players.sort((a, b) => b.age - a.age);
  return players;
}
//Progression 10 - Sort players beloging to _____ team in descending order of awards won

function filterByTeamAndSortByAwards(players, teamName) {
  const teamPlayers = players.filter(player => player.team === teamName);
  teamPlayers.sort((a, b) => b.awards - a.awards);
